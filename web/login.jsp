...
<html>
    ...
    <body>
        ...
        <div id="bd">
            ...
            <a href="index?action=join">I need to join Hubbub</a>.
            <a href="index?action=timeline">Show me the Timeline</a>.
        </div>
        <div id="ft">
            <div class="footerText">Hubbub -- Social Networking for Hackers</div>
        </div>
    </body>
</html>
